 ...
 * @author Asus
 */
public class EvenParity extends JFrame implements ActionListener{
    ...
    public void actionPerformed(ActionEvent e){
        if (e.getSource().equals(jb1)) {
            dispose();
            EvenOddParity eop=new EvenOddParity(); 
        }
